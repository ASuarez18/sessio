		...
		<div className="min-h-screen bg-gray-50 flex font-sans">
			...
			<aside className="w-56 bg-purple-950 shrink-0 flex flex-col">
				...
				<nav className="flex-1 px-3 py-4 space-y-1">
					<Link
						href="/admin"
						className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all text-white bg-purple-700"
					>
						<svg
							className="w-4 h-4"
							fill="none"
					...
					<Link
						href="/admin/events"
						className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all text-purple-300 hover:text-purple-100 hover:bg-purple-800"
					>
						<svg
							className="w-4 h-4"
							fill="none"
